...
**Full Local Mode** - All operations run locally via Zotero Desktop. No cloud dependency, no API key needed.
...
- `zotero_create_item` - Create any item type (article, book, etc.)
